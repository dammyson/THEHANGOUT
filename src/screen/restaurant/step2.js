...
export default class step2 extends Component {
  ...
  nextStep = () => {
    ...
    this.props.navigation.navigate('Rest3', {data_moving: data_moving});
        ...
        <Content>
          <View style={styles.container}>
            <View >
              ...
              <Text style={styles.titleText}>DESCRIBE YOUR RESTAURANT</Text>
            </View>
            <Text style={styles.titlesubText}>Enter a brief summary for your restaurant. Make it informative </Text>
