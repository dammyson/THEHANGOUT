...
export default class ClubDetails extends Component {
    ...
    getClubsRequest() {
        ...
        fetch(URL.url + 'merchant/dashboard/'+id+'/Club', {
            method: 'GET', headers: {
                        ...
                        <View style={styles.main_content}>
                            <View style={{ flexDirection: 'row', marginTop: 20, marginLeft: 10, marginRight: 15 }}>
                                ...
                                <View style={{ flex: 1, borderLeftWidth: 1, paddingLeft: 10, borderLeftColor: '#808080' }}>
                                    ...
                                    <Text style={{ marginLeft: 2, color: '#fff', fontSize: 12, fontWeight: '200', opacity: 0.67, }}>Reserved Spot (pcs) </Text>
                                    ...
                                    <Text style={{ marginLeft: 2, color: '#fff', fontSize: 10, fontWeight: '200', opacity: 0.67, marginTop: 35 }}> Metric</Text>
