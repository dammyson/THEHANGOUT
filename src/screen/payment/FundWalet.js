            ...
            {this.state.pay ?
              ...
              <View style={{ marginTop: 20 }}>
                ...
                <TouchableOpacity onPress={() => this.displayCard()} style={[styles.enablebutton, { marginTop: 20 }]} block iconLeft>
                  <Text style={{ color: color.secondary_color, marginTop: 10, marginBottom: 15, fontSize: 16, fontWeight: '200', fontFamily: 'NunitoSans', }}>FUND ₦{this.amountFeildFomeater(this.state.amount)}</Text>
                </TouchableOpacity>
              </View>
            }
          </View>
